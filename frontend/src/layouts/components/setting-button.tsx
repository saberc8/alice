			...
			<SheetContent style={sheetContentBgStyle} className="gap-0" onOpenAutoFocus={(e) => e.preventDefault()}>
				...
				<ScrollArea>
					<div className="flex flex-col gap-6 px-6 py-2">
						...
						{/* theme layout */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle1">主题布局</Text>
							...
							<div className="flex flex-row items-center justify-between">
								<Tooltip delayDuration={700} defaultOpen={false} disableHoverableContent>
									<TooltipTrigger>
										<Text variant="subTitle2">内容拉伸</Text>
										<Icon icon="solar:question-circle-linear" className="ml-1" />
									</TooltipTrigger>
									<TooltipContent>启用后，内容区域将拉伸以填充可用空间。</TooltipContent>
								</Tooltip>
								<Switch
						...
						{/* theme presets */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle1">主题预设</Text>
						...
						{/* font */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle1">字体设置</Text>
						...
						{/* Page config */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle1">页面设置</Text>
							<div className="flex items-center justify-between">
								<Text variant="subTitle2">面包屑导航</Text>
